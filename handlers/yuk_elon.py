...
async def narx_qabul(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❗️ Raqam kiriting!", reply_markup=back_button())
        return "narx"
...
async def telefon_qabul(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ Yuk e’loningiz joylandi!", reply_markup=ReplyKeyboardRemove())
