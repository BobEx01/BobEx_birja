...
# --- VIP/SUPER XIZMATLAR UCHUN BONUS PAKET FUNKSIYASI ---
...
async def handle_vip_super_tolov(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'vip_tolov':
        await query.edit_message_text("💳 *VIP E'lon uchun to‘lov sahifasi:* https://to'lovlinki/vip\n💵 Narx: 45,000 so'm", parse_mode='Markdown')
    elif query.data == 'super_tolov':
        await query.edit_message_text("💳 *Super E'lon uchun to‘lov sahifasi:* https://to'lovlinki/super\n💵 Narx: 90,000 so'm", parse_mode='Markdown')
...
def main():
    ...
    # --- YUK ELON UCHUN MUHLAT TUGASH VA QOLDIR/UCHIR CALLBACK ---
